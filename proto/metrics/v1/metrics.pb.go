...
type Metric struct {
	...
	xxx_hidden_Type  Metric_MType           `protobuf:"varint,2,opt,name=type,proto3,enum=metrics.v1.Metric_MType"`
...
const file_proto_metrics_v1_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12T\n" +
	"\rUpdateMetrics\x12 .metrics.v1.UpdateMetricsRequest\x1a!.metrics.v1.UpdateMetricsResponseB8Z6github.com/ibeloyar/metrics/proto/metrics/v1;metricsv1b\x06proto3"

var file_proto_metrics_v1_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_metrics_v1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
